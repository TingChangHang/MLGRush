...
public class SettingManager {
	...
	public static String lineformessage$StartTimer5 = "%RUSH_PREFIX%" +"比赛将在 5 秒后开始!";
	public static String lineformessage$StartTimer4 = "%RUSH_PREFIX%" +"比赛将在 4 秒后开始!";
	public static String lineformessage$StartTimer3 = "%RUSH_PREFIX%" +"比赛将在 3 秒后开始!";
	public static String lineformessage$StartTimer2 = "%RUSH_PREFIX%" +"比赛将在 2 秒后开始!";
	public static String lineformessage$StartTimer1 ="%RUSH_PREFIX%" + "比赛将在 1 秒后开始!";
	public static String lineformessage$Start = "战斗开始";
	public static String lineformessage$NoticeStart = "%RUSH_PREFIX%" + "%RUSH_PLAYERA%" + " 与 " + "%RUSH_PLAYERB%" + " 之间的战斗开始了!";
	...
	public static String lineformessage$ExitGame = "%RUSH_PREFIX%" + "%player_name%" + " 畏惧而逃!";
	public static String lineformessage$BeKickGame = "%RUSH_PREFIX%" + "%player_name%" + " 在战斗中服务器踢出!";
	...
	public static String lineformessage$CantfindRegion = "%RUSH_PREFIX%" + "区域不存在.";
	public static String lineformessage$SetingSuccess = "%RUSH_PREFIX%" + "设置成功!";
	public static String lineformessage$ArriveHeightest = "%RUSH_PREFIX%" + "已经到达最高建筑高度了!";
	public static String lineformessage$RoomFull = "%RUSH_PREFIX%" + "房间已满员……请等候!";
	public static String lineformessage$InQueue = "%RUSH_PREFIX%" + "已经加入匹配队列!请耐心等候，游戏不久后开始!";
	public static String lineformessage$InQueuePlayerSize = "%RUSH_PREFIX%" + "当前匹配人数: " + "%RUSH_MATCHINGPLAYERSIZE%" + "人(包括你自己).";
	public static String lineformessage$ExitQueue = "%RUSH_PREFIX%" + "已成功退出匹配!";
	public static String lineformessage$MathingEnded = "%RUSH_PREFIX%" + "该局比赛已经结束.";
	public static String lineformessage$ToBeSpecer = "%RUSH_PREFIX%" + "您已经进入观战模式. \n 使用 /spawn 来退出观战!";
	...
	public static String lineformessage$LeaveGameMessage = "%RUSH_PREFIX%" + "你离开了游戏！";
	...
	public static String lineforGui$Spec = "%RUSH_PREFIX%" + "观战面板";
